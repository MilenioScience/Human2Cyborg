...
class UGATIT(object) :
    ...
    def build_model(self):
        ...
        self.trainA = ImageFolder(os.path.join('dataset', self.dataset, 'Human_photo_train'), train_transform)
        self.trainB = ImageFolder(os.path.join('dataset', self.dataset, 'Cyborgphoto_train'), train_transform)
        self.testA = ImageFolder(os.path.join('dataset', self.dataset, 'test_Human_photo'), test_transform)
        self.testB = ImageFolder(os.path.join('dataset', self.dataset, 'test_Cyborg_photo'), test_transform)
    ...
    def load(self):
        params = torch.load('results/HumantoCyborg/_params_latest.pt')
    ...
    def test(self):
#         model = glob(os.path.join(self.result_dir, self.dataset, '*.pt'))
        self.load()
        print(" [*] Load SUCCESS")
#         print(model)
#         if not len(model) == 0:
#             model.sort()
# #             print(int(model[-1]))
#             print(int(model[0].split('_')))
#             print(int(model[0].split('_')[-1].split('.')[0]))
#             iter = int(model[0].split('_')[-1].split('.')[0])
#             self.load(os.path.join(self.result_dir, self.dataset), iter)
#             print(" [*] Load SUCCESS")
#         else:
#             print(" [*] Load FAILURE")
#             return
